...
func _init(
	topic: String,
	event: String,
	ref: String = NO_REPLY_REF,
	join_ref: String = GLOBAL_JOIN_REF,
	payload: Dictionary = {}
):
	_message = {topic = topic, event = event, payload = payload, ref = ref, join_ref = join_ref}
...
func get_join_ref() -> String:
	return _message.join_ref
